...
public class HelloStage extends Stage<HelloStage> {
    ...
    public HelloStage get_TestDto() throws Exception {
//        mvcResult.andExpect( content().contentType("TestDto"));
        mvcResult.andExpect(jsonPath("$.testName").value(IsNull.notNullValue()));
        return this;
    }
}
